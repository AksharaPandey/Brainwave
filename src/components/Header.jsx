  ...
  return (
    <div className="fixed top-0 left-0 z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav className="hidden fixed top-[5rem] left-0 bottom-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent">
        ...
        <a
          href="#signup"
          className="button hidden lg:block mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:black"
        >
          New account
        </a>
